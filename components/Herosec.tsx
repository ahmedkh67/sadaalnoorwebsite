...
const Herosec = () => {
  return (
    ...
    <div className="flex justify-center items-center w-full md:h-[600px] h-[450px] HeroBackground">
        ...
        <motion.div initial={{translateY: 30, opacity: 0}} animate={{translateY: 0, opacity: 100}} transition={{duration: 0.8, ease: easeInOut , delay: 1.5}} className="flex justify-center items-center flex-col w-full h-[600px] absolute top-0 mt-20 md:mt-35 left-0">
