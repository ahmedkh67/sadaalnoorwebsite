  ...
  return (
    ...
    <div className="flex justify-center items-center w-full md:h-[550px] h-[450px] HeroBackground">
            ...
            <div className="flex md:flex-row flex-col bg-blue-400  justify-center items-center px-4 pt-10 flex-wrap">       
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor1 "> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor2"> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor3"> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor4"> 

                    
                </div>
               
               
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor5"> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor6"> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor7"> 

                    
                </div>
                <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end decor8"> 
